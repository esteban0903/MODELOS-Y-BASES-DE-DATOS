...
CREATE TABLE EVALUACIONES( 
    ...
    fecha       DATE  NOT NULL,
    descripcion xmltype, -- Agregamos que esta podría ser nula -- 
...
VALUES ('202301', 'CC', 'nid001', TO_DATE('2024-03-15', 'YYYY-MM-DD'),
        XMLType('<evaluacion>
                   <descripcion tipo="A">A</descripcion>
                 </evaluacion>'),
        'https://reporte1.pdf', 'PE');
        
INSERT INTO EVALUACIONES (a_omes, tid, nid, fecha, descripcion, reporte, resultado)
VALUES ('202302', 'CC', 'nid002', TO_DATE('2024-03-16', 'YYYY-MM-DD'),
        XMLType('<evaluacion>
                   <descripcion tipo="B">B</descripcion>
                 </evaluacion>'),
...
--POBLARNOK--
-- VALOR DE TIPO NO PERMITIDO (descripcion solo puede tener A,M,B--
INSERT INTO EVALUACIONES (a_omes, tid, nid, fecha, descripcion, reporte, resultado)
VALUES ('202301', 'CC', 'nid001', TO_DATE('2024-03-15', 'YYYY-MM-DD'),
        XMLType('<?xml version="1.0"?>
                 <evaluaciones>
                   <descripcion tipo="X">A</descripcion> 
                 </evaluaciones>'),
        'https://reporte1.pdf', 'PE');
        
        
-- CONSULTAS--
--Consultar anomalias de prioridad alta en estado pendiente
SELECT evaluacionA,respuesta
FROM EVALUACIONES a
JOIN RESPUESTAS b ON a.a_omes=b.evaluacionA
WHERE EXTRACTVALUE(descripcion, 'evaluacion/descripcion') = 'A'
  AND resultado = 'PE';
...
<!DOCTYPE evaluaciones [
  ...
  <!ATTLIST descripcion
    ...
    puntaje CDATA #IMPLIED>
]>


--POBLARNUEVO---
INSERT INTO EVALUACIONES (a_omes, tid, nid, fecha, descripcion, reporte, resultado)
VALUES ('202303', 'CC', 'nid003', TO_DATE('2024-03-17', 'YYYY-MM-DD'),
        XMLType('<?xml version="1.0"?>
                 <evaluaciones>
                    <descripcion tipo="A" ubicacion="Oficina principal" puntaje="85">
                    </descripcion>
                 </evaluaciones>'),
        'https://reporte3.pdf', 'PE');
