...
VALUES
('001', NULL, NULL, 'Rep1', 'Universidad1', 'Direcci�n1');

INSERT INTO UNIVERSIDAD (codigo, usuarioTid, usuarioNid, representante, nombre, direccion)
VALUES
('002', NULL, NULL, 'Rep2', 'Universidad2', 'Direcci�n2');

INSERT INTO UNIVERSIDAD (codigo, usuarioTid, usuarioNid, representante, nombre, direccion)
VALUES
('003', NULL, NULL, 'Rep3', 'Universidad3', 'Direcci�n3');

INSERT INTO UNIVERSIDAD (codigo, usuarioTid, usuarioNid, representante, nombre, direccion)
VALUES
('004', NULL, NULL, 'Rep4', 'Universidad4', 'Direcci�n4');
...
VALUES (1, '001', '002', '003', '003', 'CAT01', 'Descripci�n 1', 'Nuevo', 'foto1.jpg', 100.00, 'Y');

INSERT INTO ARTICULO (id, usuarioUtid, usuarioUnid, usuarioCtid, usuarioCnid, categoriaC, descripcion, estado, foto, precio, disponible)
VALUES (2, '002', '002', '001', '001', 'CAT02', 'Descripci�n 2', 'Usado', 'foto2.jpg', 50.00, 'N');

INSERT INTO ARTICULO (id, usuarioUtid, usuarioUnid, usuarioCtid, usuarioCnid, categoriaC, descripcion, estado, foto, precio, disponible)
VALUES (3, '003', '001', '004', '004', 'CAT03', 'Descripci�n 3', 'Reparaci�n', 'foto3.jpg', 75.00, 'Y');

INSERT INTO ARTICULO (id, usuarioUtid, usuarioUnid, usuarioCtid, usuarioCnid, categoriaC, descripcion, estado, foto, precio, disponible)
VALUES (4, '004', '003', '002', '002', 'CAT01', 'Descripci�n 4', 'Nuevo', 'foto4.jpg', 120.00, 'N');

-- Poblando CATEGORIAS --
INSERT INTO CATEGORIAS (codigo, nombre, tipo, minimo, maximo, auditoriaI)
VALUES ('CAT01', 'Categor�a 1', 'Electr�nica', 50.00, 200.00, 1);

INSERT INTO CATEGORIAS (codigo, nombre, tipo, minimo, maximo, auditoriaI)
VALUES ('CAT02', 'Categor�a 2', 'Hogar', 30.00, 150.00, 2);

INSERT INTO CATEGORIAS (codigo, nombre, tipo, minimo, maximo, auditoriaI)
VALUES ('CAT03', 'Categor�a 3', 'Ropa', 20.00, 100.00, 3);

INSERT INTO CATEGORIAS (codigo, nombre, tipo, minimo, maximo, auditoriaI)
VALUES ('CAT04', 'Categor�a 4', 'Otro', 10.00, 80.00, 4);

-- Poblando AUDITORIAS --
INSERT INTO AUDITORIAS (id, fecha, ACCION, nombre)
VALUES (1, TO_DATE('2024-03-14', 'YYYY-MM-DD'), 'Crear', 'Auditor�a 1');

INSERT INTO AUDITORIAS (id, fecha, ACCION, nombre)
VALUES (2, TO_DATE('2024-03-15', 'YYYY-MM-DD'), 'Actualizar', 'Auditor�a 2');

INSERT INTO AUDITORIAS (id, fecha, ACCION, nombre)
VALUES (3, TO_DATE('2024-03-16', 'YYYY-MM-DD'), 'Eliminar', 'Auditor�a 3');

INSERT INTO AUDITORIAS (id, fecha, ACCION, nombre)
VALUES (4, TO_DATE('2024-03-17', 'YYYY-MM-DD'), 'Crear', 'Auditor�a 4');

-- Poblando EVALUACION --
INSERT INTO EVALUACION (a_omes, tid, nid, fecha, descripcion, reporte, resultado, respuestas, auditoriaI)
VALUES ('Instituci�n', 'tid001', 'nid001', TO_DATE('2024-03-14', 'YYYY-MM-DD'), 'Descripci�n evaluaci�n 1', 'reporte1.pdf', 'Aprobado', 'Respuestas evaluaci�n 1', 1);

INSERT INTO EVALUACION (a_omes, tid, nid, fecha, descripcion, reporte, resultado, respuestas, auditoriaI)
VALUES ('Estudiante', 'tid002', 'nid002', TO_DATE('2024-03-15', 'YYYY-MM-DD'), 'Descripci�n evaluaci�n 2', 'reporte2.pdf', 'Rechazado', 'Respuestas evaluaci�n 2', 2);

INSERT INTO EVALUACION (a_omes, tid, nid, fecha, descripcion, reporte, resultado, respuestas, auditoriaI)
VALUES ('Administrativo', NULL, NULL, TO_DATE('2024-03-16', 'YYYY-MM-DD'), 'Descripci�n evaluaci�n 3', 'reporte3.pdf', 'Pendiente', 'Respuestas evaluaci�n 3', 3);

INSERT INTO EVALUACION (a_omes, tid, nid, fecha, descripcion, reporte, resultado, respuestas, auditoriaI)
VALUES ('Docente', 'tid004', 'nid004', TO_DATE('2024-03-17', 'YYYY-MM-DD'), 'Descripci�n evaluaci�n 4', 'reporte4.pdf', 'Aprobado', 'Respuestas evaluaci�n 4', 4);
...
La longitud de la pk c�digo deber�a ser m�ximo de 3, aqu� es de 4, por eso devuelve un error.
...
INSERT INTO USUARIOS (universidadC, codigo, tid, nid, nombre, programa, correo, registro, suspension, nSuspensiones) 
VALUES ('Uni', '001', '001', '001', 'MismasPK', 'Nodeber�a', 'repetirse', '14-03-20-24' , NULL, 0);

La llave reporte deber�a ser �nica, y en este caso al intentar insertar valores repetidos devuelve un error, pues se viola la restricci�n.

INSERT INTO EVALUACION (a_omes, tid, nid, fecha, descripcion, reporte, resultado, respuestas, auditoriaI)
VALUES ('Administrativo', '001', '999', TO_DATE('2024-03-16', 'YYYY-MM-DD'), 'Descripci�n evaluaci�n 3', 'reporte44.pdf', 'Por hacer', 'Respuestas evaluaci�n 3', 3);


-- Parte (3) --

En este caso tenemos una universidad que no se referencia a nin�n estudiante, pero si repite la PK
que deber�a ser �nica y a�n as� la a�adi�.

INSERT INTO UNIVERSIDAD (codigo, usuarioTid, usuarioNid, representante, nombre, direccion)
VALUES
('001', NULL, NULL, 'Rep1', 'Universidad55', 'Calle 17A # 75 ');

En este caso la PK de Usuarios es tid, nid, y se repiten, primer error, adem�s deber�a comprobar 
que la universidad existiera.

INSERT INTO USUARIOS (universidadC, codigo, tid, nid, nombre, programa, correo, registro, suspension, nSuspensiones) 
VALUES ('Uni', '001', '001', '001', 'MismasPK', 'Nodeber�a', 'repetirse', TO_DATE('14-03-2024', 'DD-MM-YYYY'), NULL, 0);

Funciona pero no deber�a, puesto que usa las FK's de tid y nid, deber�a comprobar que existan en la tabla de Usuarios
y en este caso, esos tid y nid no existen para ning�n usuario.
