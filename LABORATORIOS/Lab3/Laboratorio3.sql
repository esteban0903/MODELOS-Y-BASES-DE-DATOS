...
CREATE TABLE CATEGORIAS(
    ...
    auditoriaI  INTEGER NOT NULL,
    pertenecimientos  VARCHAR(20) NOT NULL
);
...
ALTER TABLE CATEGORIAS ADD CONSTRAINT FK_CATEGORIAS_CATEGORIAS_pertenecimientos
FOREIGN KEY(pertenecimientos) REFERENCES CATEGORIAS(codigo);
